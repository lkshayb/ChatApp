...
export default function Landing():ReactElement{
        ...
        return (
            <div className="z-50  backdrop-blur-lg  border-b-2 border-orange-600 items-center fixed bg-black/80 text-white top-0 left-0 w-screen px-8 py-4 flex items-center justify-between md:justify-around ">
                ...
                <div className="md:flex gap-10 items-center hidden">
                    ...
                    <Link to="https://github.com/lkshayb/chatapp" target="_blank">
                ...
                <div className={`${menu ? "block" : "hidden"} transition-all duration-300 ease-in-out flex flex-col md:hidden py-2 px-4 text-xl bg-black text-white absolute left-0 right-0 top-[101%]`}>
                    ...
                    <Link to="https://github.com/lkshayb/chatapp" target="_blank" className="mb-2 hover:from-orange-500 hover:to-orange-400 hover:shadow-sm duration-200  hover:shadow-orange-300 flex gap-3 py-3 px-8 items-center bg-gradient-to-r from-orange-700 to-orange-500 rounded-lg text-black font-semibold">
    ...
    function Hero({ refProp }: { refProp: React.RefObject<HTMLDivElement> }):ReactElement{
        function Card(props:any){
            return(
                <div className="cursor-default py-5 px-8 mt-5 bg-black/10 border-orange-500/30 border backdrop-blur-md rounded-xl md:w-[100%] sm:w-[600px] hover:scale-105 duration-300">
    ...
    function Features({ refProp }: { refProp: React.RefObject<HTMLDivElement> }):ReactElement{
        function Card(props:any){
            return (
                <div  className="max-w-[400px] z-90 group bg-gradient-to-tl from-gray-900 to-[black] rounded-xl border-orange-700/30 border  sm:w-auto w-[300px]  text-white pt-7 pl-7 hover:border-orange-700/60 duration-300 shadow-xl hover:scale-105 hover:shadow-orange-700/20 cursor-default">
    ...
    function Preview({ refProp }: { refProp: React.RefObject<HTMLDivElement> }):ReactElement{
        function Card(props:any){
            return(
                <div  className="cursor-default hover:scale-105 py-8 px-[50px] mt-5 bg-orange-500/30 border-orange-500/30 border backdrop-blur-md rounded-xl md:w-[100%] sm:w-[600px] w-[300px] hover:scale-105 duration-300">
